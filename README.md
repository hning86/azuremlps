...
## Installation
From the Release area, download the _AzureMLPS.dll_ which is a PowerShell module file. Then run the PowerShell command _Import-Module_ to import it into the current PowerShell environment:
